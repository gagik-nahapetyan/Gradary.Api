...
public interface IBookCollectionRepository : IRepository<BookCollection>
{
    ...
    /// </summary>
    Task<IEnumerable<BookCollection>> GetByUserIdAsync(int userId, CancellationToken cancellationToken = default, bool tracked = false);

    /// <summary>
    /// Gets a collection by id including its items.
    /// </summary>
    Task<BookCollection?> GetByIdWithItemsAsync(int id, CancellationToken cancellationToken = default, bool tracked = false);
}
